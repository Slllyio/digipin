...
const APP_GLOBALS = {
  ...
  DISHAActions: 'readonly', DISHATools: 'readonly', DISHAAgent: 'readonly',
  ...
  OvertureBuildings: 'readonly', DeckBuildings: 'readonly', deck: 'readonly',
  Isochrone: 'readonly', Report: 'readonly', TrainingDataGen: 'readonly',
