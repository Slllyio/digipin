/**
 * Digital Twin Data Layers — Guna City
 *
 * Layer sources:
...
const DigitalTwinLayers = (() => {
    ...
    const LAYER_DEFS = {
        ...
        google_buildings: {
            ...
            group: 'Buildings',
            isPMTiles: true,
            pmtilesUrl: `${DATA_BASE}/vectors/google_open_buildings_guna.pmtiles`,
        ...
        city_boundary: {
            ...
            minZoom: 8,
            tooltip: () => 'Guna Municipal Boundary'
        },
        osm_admin: {
            name: 'Admin Zones (OSM)',
            icon: '\u{1F5FA}',
            file: 'vectors/osm_admin_boundaries_guna.geojson',
            group: 'Boundaries',
            type: 'fill',
            paint: {
                'fill-color': '#818cf8',
        ...
        osm_green_spaces: {
            ...
            icon: '\u{1F333}',
            file: 'vectors/osm_green_spaces_guna.geojson',
            group: 'Environment',
            type: 'fill',
            paint: {
                'fill-color': '#22c55e',
        ...
        osm_pois: {
            ...
            icon: '\u{1F4CD}',
            file: 'vectors/osm_pois_guna.geojson',
            group: 'Local Data',
            type: 'circle',
            paint: {
                'circle-radius': [
        ...
        osm_shops: {
            name: 'Shops & Markets',
            icon: '\u{1F6CD}',
            file: 'vectors/osm_shops_guna.geojson',
            group: 'Local Data',
            type: 'circle',
            paint: {
                'circle-radius': [
        ...
        osm_railways: {
            ...
            icon: '\u{1F682}',
            file: 'vectors/osm_railways_guna.geojson',
            group: 'Local Data',
            type: 'circle',
            paint: {
                'circle-radius': [
        ...
        osm_utilities: {
            ...
            icon: '\u{26A1}',
            file: 'vectors/osm_utilities_guna.geojson',
            group: 'Local Data',
            type: 'circle',
            paint: {
                'circle-radius': [
        ...
        osm_roads: {
            ...
            icon: '\u{1F6E3}',
            file: 'vectors/osm_roads_guna.geojson',
            group: 'Local Data',
            type: 'line',
            paint: {
                'line-color': [
        ...
        osm_water: {
            ...
            icon: '\u{1F4A7}',
            file: 'vectors/osm_water_guna.geojson',
            group: 'Environment',
            type: 'fill',
            paint: {
                'fill-color': '#0ea5e9',
    ...
    // Guna city boundary (approximate municipal limits)
        ...
        features: [{
            ...
            geometry: {
                ...
                coordinates: [[
                    ...
                    [77.258, 24.620], [77.265, 24.590]
                ]]
            },
            properties: { name: 'Guna Municipal Boundary', source: 'Approximate' }
        }]
    };
    ...
    async function _loadSensorData(key) {
        const CENTER = { lat: 24.6354, lon: 77.3126 };
    ...
    async function toggle(key, map) {
        ...
        try {
            if (def.isRaster) {
                state.loading = false;
                throw new Error('GeoTIFF display requires XYZ tile conversion.');
            }
