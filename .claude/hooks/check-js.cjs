...
// Skip test files — they use ESM `import` syntax which `node --check`
// can't parse against this project's CJS-typed package.json. Vitest
// validates them natively at test-run time.
